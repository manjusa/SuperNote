...
public sealed class NoteCreatedDomainEventHandler
  : INotificationHandler<NoteCreatedDomainEvent>
{
    private readonly ILogger<NoteCreatedDomainEventHandler> _logger;

    public NoteCreatedDomainEventHandler(
        ILogger<NoteCreatedDomainEventHandler> logger)
    {
        _logger = logger;
    }

    public async Task Handle(
      NoteCreatedDomainEvent notification,
